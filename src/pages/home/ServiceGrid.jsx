    ...
    <div className='servFlex'>
        ...
        <div className='serviceGridContainer'>
            <div className='serviceGridItem'>
                    <h5 className='servH5'>Advertising</h5>
                    <img src={advertising} alt="" />
            </div>
            <div className='serviceGridItem'>
                <h5 className='servH5'>Web Design</h5>
                <img src={webDesign} alt="" />
            </div>
            <div className='serviceGridItem'>
                <h5 className='servH5'>Social Media</h5>
                <img src={socialMedia} alt="" />
            </div>
            <div className='serviceGridItem'>
                <h5 className='servH5'>Brand Identity</h5>
                <img src={brandIdentity} alt="" />
            </div>
            <div className='serviceGridItem'>
                <h5 className='servH5'>Film Photography</h5>
                <img src={filmPhotography} alt="" />
            </div>
            <div className='serviceGridItem'>
                <h5 className='servH5'>Label Design</h5>
                <img src={labelDesign} alt="" />
            </div>
            <div className='serviceGridItem'>
                <h5 className='servH5'>Apparel Design</h5>
                <img src={apparelDesign} alt="" />
            </div>
            <div className='serviceGridItem'>
                <h5 className='servH5'>Content Creation</h5>
